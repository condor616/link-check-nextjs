      ...
      <div className="row">
        <div className="col-12 col-md-3 mb-4">
          <div className="nav flex-column nav-pills" role="tablist">
            <button
              className={`nav-link text-start py-3 px-4 mb-2 ${activeTab === 'site-config' ? 'active shadow-sm' : ''}`}
            ...
            <AnimatedCard>
              <div className="d-flex align-items-center gap-2 mb-4">
                ...
                <div>
                  ...
                  <p className="text-muted small mb-0">Configure your application's base URL for SEO and social sharing</p>
                </div>
              </div>
